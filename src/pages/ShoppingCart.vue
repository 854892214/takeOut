...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      totalAmount(goods) {
        return util.amountMul(this.afterDiscountAmount(goods), goods.count);
      },
      univalentAmount(goods) {
        return util.amountAdd(goods.amount,goods.specAmount);
      },
      afterDiscountAmount(goods) {
        return util.amountAdd(util.round(util.amountMul(goods.amount, goods.discount), 2),goods.specAmount);
      },
